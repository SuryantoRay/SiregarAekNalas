...
@section('konten')
    ...
    <div class="containeri">
        <div class="row">
            <div class="col-4">
                @if ($p->pengusaha->file == "-" || $p->pengusaha->file == "")
                    <img class="user" src="{{ asset('Beranda/user.png') }}">
                @else
                    <img class="user" src="{{ asset('Pembeli/user/'.$p->pengusaha->file) }}" alt="">
                @endif
            </div>
            <div class="col-8">
                <div class="conten1">
                    <table class="table">
                        <tr>
                            <td>Nama</td>
                            <td>:</td>
                            <td>{{ $p->pengusaha->nama }}</td>
                        </tr>
                        <tr>
                            <td>Tanggal Lahir</td>
                            <td>:</td>
                            <td>{{ $p->pengusaha->tanggal_lahir }}</td>
                        </tr>
                        <tr>
                            <td>Alamat</td>
                            <td>:</td>
                ...
                <div class="conten2">
                    <table class="table">
                        ...
                        <tr>
                            <td>No Handphone</td>
                            <td>:</td>
                            <td>{{ $p->pengusaha->no_handphone }}</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>Whatsapp</td>
                            <td>:</td>
                            <td>{{ $p->pengusaha->whatsapps }}</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td></td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			@endif
            <form action="/editGambar/{{ $p->pengusaha->user_id }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			@endif
            <form action="/editData/{{ $p->pengusaha->user_id }}" method="post">
                {{ csrf_field() }}
                <table class="table">
                    <tr>
                        <td>Nama</td>
                        <td>:</td>
                        <td><input type="text" class="form-control" name="nama" value="{{ $p->pengusaha->nama }}" class="" id=""></td>
                    </tr>
                    <tr>
                        <td>Tanggal Lahir</td>
                        <td>:</td>
                        <td><input type="date" class="form-control" name="tanggal_lahir" value="{{ $p->pengusaha->tanggal_lahir }}" class="" id=""></td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>No Handphone</td>
                        <td>:</td>
                        <td><input type="text" class="form-control" name="no_handphone" value="{{ $p->pengusaha->no_handphone }}" class="" id=""></td>
                    </tr>
                    <tr>
                        <td>Whatsapp</td>
                        <td>:</td>
                        <td><input type="text" class="form-control" name="whatsapps" value="{{ $p->pengusaha->whatsapps }}" class="" id=""></td>
                    </tr>
                </table>
        </div>
                <div class="modal-footer">
