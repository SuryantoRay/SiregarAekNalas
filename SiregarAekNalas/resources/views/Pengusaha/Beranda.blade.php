...
<body class="body">
    ...
    <nav class="navbar navbar-expand-lg navbar-light pm">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          ...
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0 bacv">
            <li class="nav-item active">
              <a class="navi" href="/homee/{{ Auth::user()->id }}">Home <span class="sr-only"></span></a>
            </li>
            <li class="nav-item">
              <a class="navi" style="" href="/pesaanan/{{ Auth::user()->id }}">Pesanan</a>
            </li>
            <li class="nav-item">
                <a class="navi" href="/edit_Produk/{{ Auth::user()->id }}">Edit Produk</a>
              </li>
              <li class="nav-item">
                <a class="navi" href="/tambah_produk/{{ Auth::user()->id }}">Tambah Produk</a>
              </li>
              <li class="nav-item">
                <a class="navi" href="/dataPribadii/{{ Auth::user()->id }}">Data Pribadi</a>
              </li>
              <form class="">
                <input class="form-control f" type="search" placeholder="Search" aria-label="Search">
              </form>
          </ul>
                @if (Auth::user()->pengusaha->file == "-" || Auth::user()->pengusaha->file == "")
                    <img class="luser" src="{{ asset('Beranda/user.png') }}">
                @else
                    <img class="luser" src="{{ asset('Pembeli/user/'.Auth::user()->pengusaha->file) }}" alt="">
                @endif |
